...
const requiredAttributes=[
  ...
  'data-question-difficulty','data-question-prompt','data-question-choices','data-practice-question-actions',
...
console.log(JSON.stringify({requiredSelectors:requiredAttributes.length,learnerOnly:true,rawSourceKeysHidden:true,questionActions:true,verifiedResourceTitles:true},null,2));
