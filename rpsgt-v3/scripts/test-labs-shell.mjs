...
if(!html.includes('Hookup, Scoring, Respiratory, Instrumentation, PAP, Integrated Troubleshooting, Pediatric and Infant Sleep, and Math Coach are v3-ready')||!html.includes('MSLT/MWT catalog-only card stays visibly disabled')) throw new Error('Individual laboratory and remaining parity boundaries are not visible to learners.');
