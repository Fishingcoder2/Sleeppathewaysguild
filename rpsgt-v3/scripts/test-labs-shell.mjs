...
if(!html.includes('Hookup, Scoring, and Math Coach are v3-ready')||!html.includes('visibly disabled')) throw new Error('Individual laboratory and remaining parity boundaries are not visible to learners.');
