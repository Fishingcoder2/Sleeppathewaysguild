...
if(!html.includes('Hookup, Scoring, Respiratory, Instrumentation, PAP, Integrated Troubleshooting, Pediatric and Infant Sleep, MSLT/MWT Protocols, and Math Coach are v3-ready')||!html.includes('preserve-versus-rebuild decision remains open'))throw new Error('Individual laboratory readiness and EKG parity boundary are not visible to learners.');
console.log('Laboratory catalog page selector, script-order, nine-ready-lab, EKG-boundary, and read-only contracts passed.');
