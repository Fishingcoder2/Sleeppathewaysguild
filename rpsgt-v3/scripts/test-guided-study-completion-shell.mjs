...
assert.match(coachSafety,/sanitizedPanels=new WeakSet/);
assert.match(coachSafety,/sanitizedPanels\.has\(panel\)/);
assert.match(actions,/titlesForQuestion\(question\)/);
assert.match(actions,/pane\.querySelector\('\[data-guided-question-actions\]'\)\) return;\s*enhanceCoach\(question\)/);
