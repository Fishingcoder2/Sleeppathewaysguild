...
for(const learnerMarker of ['Guild task badge','named Guild domain medal','Sleep Pathways Guild educational achievements']) if(!studyHtml.includes(learnerMarker)) throw new Error(`Guided Study learner copy is missing ${learnerMarker}.`);
