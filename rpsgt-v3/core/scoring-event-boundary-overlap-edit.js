...
<div class="live-psg-head"><div><div class="eyebrow">Live PSG Simulator · Continuous review</div><h2>One full screen = exactly 30 real-time seconds</h2><p>All 12 channels share one clock and one horizontal timebase. The synthetic page scrolls continuously from right to left, so every signal sample takes exactly 30 seconds to cross the plot.</p></div><span class="live-psg-badge">Shared clock · 30.0 s</span></div>
