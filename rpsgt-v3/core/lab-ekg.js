...
function stripPath(kind){
  ...
  if(kind==='concerning-run'){
    const normalBeats=[78,188,298],runBeats=[365,415,465,515,565,615],recoveryBeats=[742,842];
