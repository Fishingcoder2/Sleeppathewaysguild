...
- Hookup, Sleep Staging and Event Scoring, Respiratory Signals and Event Recognition, Instrumentation, Filters, and Signal Pathways, PAP and Titration, Integrated Troubleshooting, and Math Coach now have individual v3 laboratory experiences. The preserved EKG destination remains linked; Pediatric/Infant Sleep and MSLT/MWT remain disabled until their individual parity work is complete.
...
2. Migrate and validate Pediatric/Infant Sleep and MSLT/MWT, then make the EKG preserve-versus-rebuild decision; the seven native v3 labs do not establish full laboratory parity.
