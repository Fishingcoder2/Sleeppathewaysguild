...
- Hookup, Sleep Staging and Event Scoring, Respiratory Signals and Event Recognition, Instrumentation, Filters, and Signal Pathways, PAP and Titration, Integrated Troubleshooting, Pediatric and Infant Sleep, and Math Coach now have individual v3 laboratory experiences. The preserved EKG destination remains linked; MSLT/MWT remains disabled until its individual parity work is complete.
...
2. Migrate and validate MSLT/MWT, then make the EKG preserve-versus-rebuild decision; the eight native v3 labs do not establish full laboratory parity.
